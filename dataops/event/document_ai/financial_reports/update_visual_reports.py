...
COMPANY_DATA = {
    'SNOW': {
        ...
        'layout_style': 'classic'  # Professional 2-column
    },
    'NRNT': {
        ...
        'layout_style': 'bold'  # Bold centered for disruptive startup
    },
    'ICBG': {
        ...
        'layout_style': 'minimal'  # Clean minimal for open source
    },
    'QRYQ': {
        ...
        'layout_style': 'minimal'  # Clean minimal for challenger
    },
    'DFLX': {
        ...
        'layout_style': 'classic'  # Traditional for established platform
    },
    'STRM': {
        ...
        'layout_style': 'grid'  # Structured grid for data platform
    },
    'VLTA': {
        ...
        'layout_style': 'bold'  # Modern bold for AI innovator
    },
    'CTLG': {
        'full_name': 'CATALOGX',
        ...
        'layout_style': 'grid'  # Highly structured for governance
    }
}
...
<body>
    <div class="container">
        ...
        <header class="brand-gradient text-white px-8 py-6">
            <div class="flex justify-between {header_align}">
                <div>
                    <h1 class="{header_size} font-bold">{full_name}</h1>
        ...
        <div class="grid {metrics_grid} gap-3 px-8 py-5 bg-gray-50">
        ...
        <div class="grid {content_cols} gap-0 py-6 flex-1">
            <!-- Left Column - Executive Summary -->
            <div class="col-span-{col_span} space-y-4 px-8 pr-4">
                <div>
...
def generate_report(ticker, data):
    """Generate HTML report for a company with layout variations"""
    ...
    if layout_style == 'bold':
        # Bold centered - NRNT, VLTA
        header_align = 'items-center text-center'
        header_size = 'text-4xl'
        metrics_grid = 'grid-cols-2'  # 2x2 grid
        content_cols = 'grid-cols-1'  # Single column
        col_span = '1'
    elif layout_style == 'minimal':
        # Clean minimal - ICBG, QRYQ
        header_align = 'items-start'
        header_size = 'text-2xl'
        metrics_grid = 'grid-cols-4'  # Horizontal
        content_cols = 'grid-cols-2'  # Wide 2-col
        col_span = '1'
    elif layout_style == 'grid':
        # Structured grid - STRM, CTLG
        header_align = 'items-center'
        header_size = 'text-3xl'
        metrics_grid = 'grid-cols-2'  # 2x2 stacked
        content_cols = 'grid-cols-4'  # 4-col grid
        col_span = '3'
    else:  # classic
        # Classic professional - SNOW, DFLX
        header_align = 'items-center'
        header_size = 'text-3xl'
        metrics_grid = 'grid-cols-4'  # Horizontal 4
        content_cols = 'grid-cols-3'  # 2+1 layout
        col_span = '2'
...
def main():
    """Update all visual financial reports with varied layouts"""
    output_dir = Path('../financial_reports_html')
    
    print("\n🎨 Generating Visual Financial Reports with Varied Layouts\n")
    print("=" * 70)
    ...
    for ticker, data in COMPANY_DATA.items():
        ...
        print(f'✓ {ticker:6} | {layout_style:10} | {data["full_name"]}')
    
    print("=" * 70)
    print(f'\n✅ All visual reports updated in {output_dir}')
    print('\n📊 Layout Distribution:')
    print('   - Classic:  SNOW, DFLX')
    print('   - Bold:     NRNT, VLTA')
    print('   - Minimal:  ICBG, QRYQ')
    print('   - Grid:     STRM, CTLG\n')

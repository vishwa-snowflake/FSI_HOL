...
PUT file:////Users/boconnor/fsi-cortex-assistant/dataops/event/analyst/semantic_model.yaml @ACCELERATE_AI_IN_FSI.CORTEX_ANALYST.cortex_analyst auto_compress = false overwrite = true;
PUT file:////Users/boconnor/fsi-cortex-assistant/dataops/event/analyst/analyst_sentiments.yaml @ACCELERATE_AI_IN_FSI.CORTEX_ANALYST.cortex_analyst auto_compress = false overwrite = true;
